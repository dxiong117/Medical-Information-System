...
CREATE TABLE RADIOLOGYDATE (Radiology_fk BIGINT, TREATMENTDATES DATE)
...
ALTER TABLE RADIOLOGYDATE ADD CONSTRAINT FK_RADIOLOGYDATE_Radiology_fk FOREIGN KEY (Radiology_fk) REFERENCES TREATMENT (ID)
