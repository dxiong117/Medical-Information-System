...
public class ProviderResource {
	...
	public ProviderRepresentation getProvider(@PathParam("id") String pid) throws ProviderExn {
		try {
	...
	public ProviderRepresentation getProviderByNpi(@QueryParam("npi") String Npi) {
		try {
			...
			ProviderRepresentation providerRep = factory.createProviderRepresentation(providerDTO, context);
			return providerRep;
		} catch (ProviderServiceExn e) {
			throw new WebApplicationException("Not Found", 404);
		}
